        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              child: Row(
                children: [
                  SvgPicture.asset("assets/help.svg", height: 25.h,),
                  SizedBox(width: 10.w,),
                  LabelText(text: "Help", color: Colors.white,)
                ],
              ),
            ),
            SizedBox(height: 40.h,),
            Row(
              children: [
                SvgPicture.asset("assets/terms_condition_icon.svg", height: 25.h,),
                SizedBox(width: 10.w,),
                LabelText(text: "Terms and Condition ", color: Colors.white,)
              ],
            ),
            SizedBox(height: 40.h,),
            Row(
              children: [
                SvgPicture.asset("assets/privacy_logo.svg", height: 25.h,),
                SizedBox(width: 10.w,),
                LabelText(text: "Privacy policy", color: Colors.white,)
              ],
            ),
      ...
      bottomSheet: Container(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 10.w,),
            BigText(text: "Log out", color: Colors.white,)
          ],
        ),
      ),
    );
